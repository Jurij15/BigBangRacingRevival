...
public class PsUICenterNotEnoughDiamonds : PsUIHeaderedCanvas
{
	// Token: 0x06001698 RID: 5784 RVA: 0x000EE78C File Offset: 0x000ECB8C
	public PsUICenterNotEnoughDiamonds(UIComponent _parent)
		: base(_parent, "CenterNotEnoughDiamonds", true, 0.125f, RelativeTo.ScreenHeight, 0f, RelativeTo.ScreenHeight)
	{
	...
	// Token: 0x06001699 RID: 5785 RVA: 0x000EE870 File Offset: 0x000ECC70
	public void CreateHeaderContent(UIComponent _parent)
	{
		...
		UIText uitext = new UIText(uihorizontalList, false, string.Empty, PsStrings.Get(StringID.NOT_ENOUGH_GEMS_TITLE), PsFontManager.GetFont(PsFonts.KGSecondChances), 0.055f, RelativeTo.ScreenHeight, "#95e5ff", null);
	...
	// Token: 0x0600169A RID: 5786 RVA: 0x000EE98C File Offset: 0x000ECD8C
	...
	// Token: 0x0600169B RID: 5787 RVA: 0x000EEA6A File Offset: 0x000ECE6A
